...
class M_posisi extends CI_Model {
	...
	public function select_all() {
		...
		$sql = " SELECT users.id AS id, users.first_name AS first_name, users.last_name AS last_name, plots.id as plot_id,plots.owner_name AS owner_name,plots.address1,plots.address2,plots.plot_no,plots.survey_no,plots.village,plots.mandal,plots.district,plots.authority,plots.pincode,plots.state,plots.lat,plots.lag,plots.plot_map FROM users,plots WHERE users.id = plots.customer_id";
